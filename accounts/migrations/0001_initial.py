    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('phone_number', models.CharField(max_length=15, unique=True, validators=[accounts.validators.validate_phone_number])),
                ('first_name', models.CharField(blank=True, max_length=150, verbose_name='Имя')),
                ('last_name', models.CharField(blank=True, max_length=150, verbose_name='Фамилия')),
                ('email', models.EmailField(blank=True, max_length=254, verbose_name='Email')),
                ('receive_notifications', models.BooleanField(default=True)),
                ('favorite_products', models.ManyToManyField(blank=True, related_name='favorited_by', to='shop.productshop')),
